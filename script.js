...
function criptografar() {
  ...
  if (!regex.test(texto) && !verificarAcentos(texto)) {
    ...
    document.getElementById("resposta").innerHTML = textoCriptografado;
    document.querySelector(".dalek").style.display = "none";
  } else {
    document.querySelector(".dalek").style.display = "block";
  }
...
function descriptografar() {
  ...
  document.getElementById("resposta").innerHTML = textoDescriptografado;
  document.getElementById("text").value = "";

}
function copiar() {
  var textoResposta = document.getElementById("resposta").innerText;
